execute if entity @s[tag=prohibit_armor_1] run return run tellraw @s {"translate": "info.soul_alchemy.heavy_armor_already_disable_1","color": "red"}
...
tellraw @s {"translate": "info.soul_alchemy.heavy_armor_disable_1","color": "red"}
