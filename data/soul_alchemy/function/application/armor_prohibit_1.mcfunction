execute if entity @s[tag=prohibit_armor_1] run return run tellraw @s {"translate": "info.soul_alchemy.prohibition.heavy_armor.already_disable_1","color": "red"}

execute unless entity @s[tag=prohibit_armor_2] run scoreboard players add @s npe_soul_points 5

execute if entity @s[tag=prohibit_armor_2] if score @s npe_soul_points matches ..4 run return run tellraw @s {"translate": "info.soul_alchemy.not_enough_sp","color": "red"}
execute if entity @s[tag=prohibit_armor_2] run scoreboard players remove @s npe_soul_points 5

tellraw @s {"translate": "info.soul_alchemy.prohibition.heavy_armor.disable_1","color": "red"}
