execute if entity @s[tag=deactivate_weaving] run return run tellraw @s {"translate": "info.soul_alchemy.effect_already_disabled","color": "gray"}


execute if entity @s[tag=permanent_weaving] unless score @s npe_soul_points matches 2.. run return run tellraw @s {"translate": "info.soul_alchemy.not_enough_sp","color": "red"}
execute if entity @s[tag=permanent_weaving] run scoreboard players remove @s npe_soul_points 2
execute if entity @s[tag=permanent_weaving] run scoreboard players remove @s npe_perma_effect_misc 1
execute if entity @s[tag=permanent_weaving] run tellraw @s {"translate": "info.soul_alchemy.effect_disabled","color": "gray"}
