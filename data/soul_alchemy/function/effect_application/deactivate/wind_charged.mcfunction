execute if entity @s[tag=deactivate_wind_charged] run return run tellraw @s {"translate": "info.soul_alchemy.effect_already_disabled","color": "gray"}


execute if entity @s[tag=permanent_wind_charged] unless score @s npe_soul_points matches 2.. run return run tellraw @s {"translate": "info.soul_alchemy.not_enough_sp","color": "red"}
...
execute if entity @s[tag=permanent_wind_charged] run tellraw @s {"translate": "info.soul_alchemy.effect_disabled","color": "gray"}
