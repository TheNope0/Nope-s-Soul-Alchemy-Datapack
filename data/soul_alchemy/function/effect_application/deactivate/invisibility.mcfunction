execute if data entity @s {Tags:["deactivate_invisibility"]} run return run tellraw @s {"translate": "n_soul_alchemy.inform.effect_already_disabled","color": "gray"}


execute if data entity @s {Tags:["permanent_invisibility"]} run scoreboard players add @s npe_soul_points 8
execute if data entity @s {Tags:["permanent_invisibility"]} run tellraw @s {"translate": "n_soul_alchemy.inform.effect_disabled","color": "gray"}
