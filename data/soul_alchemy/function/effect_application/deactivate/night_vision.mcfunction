execute if data entity @s {Tags:["deactivate_night_vision"]} run return run tellraw @s {"translate": "n_soul_alchemy.inform.effect_already_disabled","color": "gray"}


execute if data entity @s {Tags:["permanent_night_vision"]} run scoreboard players add @s npe_soul_points 8
execute if data entity @s {Tags:["permanent_night_vision"]} run tellraw @s {"translate": "n_soul_alchemy.inform.effect_disabled","color": "gray"}
