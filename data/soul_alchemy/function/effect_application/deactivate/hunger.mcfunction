execute if entity @s[tag=deactivate_hunger] run return run tellraw @s {"translate": "info.soul_alchemy.effect_already_disabled","color": "gray"}


execute if entity @s[tag=permanent_hunger] unless score @s npe_soul_points matches 8.. run return run tellraw @s {"translate": "info.soul_alchemy.not_enough_sp","color": "red"}
execute if entity @s[tag=permanent_hunger] run scoreboard players remove @s npe_soul_points 8
execute if entity @s[tag=permanent_hunger] run scoreboard players remove @s npe_perma_effect_misc 1
execute if entity @s[tag=permanent_hunger] run tellraw @s {"translate": "info.soul_alchemy.effect_disabled","color": "gray"}
