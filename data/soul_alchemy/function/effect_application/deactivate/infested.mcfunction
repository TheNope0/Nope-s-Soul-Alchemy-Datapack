execute if data entity @s {Tags:["deactivate_infested"]} run return run tellraw @s {"translate": "n_soul_alchemy.inform.effect_already_disabled","color": "gray"}


execute if data entity @s {Tags:["permanent_infested"]} unless score @s npe_soul_points matches 4.. run return run tellraw @s {"translate": "n_soul_alchemy.inform.not_enough_sp","color": "red"}
execute if data entity @s {Tags:["permanent_infested"]} run scoreboard players remove @s npe_soul_points 4
execute if data entity @s {Tags:["permanent_infested"]} run tellraw @s {"translate": "n_soul_alchemy.inform.effect_disabled","color": "gray"}
