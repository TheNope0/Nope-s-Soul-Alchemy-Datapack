execute if data entity @s {Tags:["deactivate_levitation"]} run return run tellraw @s {"translate": "n_soul_alchemy.inform.effect_already_disabled","color": "gray"}
...
tag @s add deactivate_levitation