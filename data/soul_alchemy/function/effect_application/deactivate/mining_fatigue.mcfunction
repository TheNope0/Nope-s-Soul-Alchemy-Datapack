execute if entity @s[tag=deactivate_mining_fatigue] run return run tellraw @s {"translate": "n_soul_alchemy.inform.effect_already_disabled","color": "gray"}


execute if entity @s[tag=permanent_mining_fatigue] unless score @s npe_soul_points matches 12.. run return run tellraw @s {"translate": "n_soul_alchemy.inform.not_enough_sp","color": "red"}
execute if entity @s[tag=permanent_mining_fatigue] run scoreboard players remove @s npe_soul_points 12
execute if entity @s[tag=permanent_mining_fatigue] run tellraw @s {"translate": "n_soul_alchemy.inform.effect_disabled","color": "gray"}
