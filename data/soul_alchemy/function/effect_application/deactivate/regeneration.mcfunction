execute if entity @s[tag=deactivate_regeneration] run return run tellraw @s {"translate": "n_soul_alchemy.inform.effect_already_disabled","color": "gray"}


execute if entity @s[tag=permanent_regeneration] run scoreboard players add @s npe_soul_points 16
execute if entity @s[tag=permanent_regeneration] run tellraw @s {"translate": "n_soul_alchemy.inform.effect_disabled","color": "gray"}
