execute if entity @s[tag=permanent_invisibility] run return run tellraw @s {"translate": "info.n_soul_alchemy.effect_already_permanent","color": "gray"}


execute if entity @s[tag=deactivate_invisibility] unless score @s npe_soul_points matches 8.. run return run tellraw @s {"translate": "info.n_soul_alchemy.not_enough_sp","color": "red"}
execute if entity @s[tag=deactivate_invisibility] run scoreboard players remove @s npe_soul_points 8
execute if entity @s[tag=deactivate_invisibility] run tellraw @s {"translate": "info.n_soul_alchemy.effect_permanent","color": "gray"}
