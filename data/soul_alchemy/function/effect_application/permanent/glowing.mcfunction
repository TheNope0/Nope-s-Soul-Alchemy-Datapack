execute if entity @s[tag=permanent_glowing] run return run tellraw @s {"translate": "n_soul_alchemy.inform.effect_already_permanent","color": "gray"}


execute if entity @s[tag=deactivate_glowing] unless score @s npe_soul_points matches 6.. run return run tellraw @s {"translate": "n_soul_alchemy.inform.not_enough_sp","color": "red"}
execute if entity @s[tag=deactivate_glowing] run scoreboard players remove @s npe_soul_points 6
execute if entity @s[tag=deactivate_glowing] run tellraw @s {"translate": "n_soul_alchemy.inform.effect_permanent","color": "gray"}
