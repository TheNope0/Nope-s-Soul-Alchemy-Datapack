execute if entity @s[tag=permanent_regeneration] run return run tellraw @s {"translate": "n_soul_alchemy.inform.effect_already_permanent","color": "gray"}


execute if entity @s[tag=deactivate_regeneration] unless score @s npe_soul_points matches 16.. run return run tellraw @s {"translate": "n_soul_alchemy.inform.not_enough_sp","color": "red"}
execute if entity @s[tag=deactivate_regeneration] run scoreboard players remove @s npe_soul_points 16
execute if entity @s[tag=deactivate_regeneration] run tellraw @s {"translate": "n_soul_alchemy.inform.effect_permanent","color": "gray"}
