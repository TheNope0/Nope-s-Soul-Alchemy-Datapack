execute if score .WORLDDIFFICULTY. npe_difficulty matches 5 run return run tellraw @s {"translate": "info.soul_alchemy.uhc.regeneration","color": "red"}
...
execute if entity @s[tag=deactivate_regeneration] run scoreboard players add @s npe_perma_effect_misc 1
execute if entity @s[tag=deactivate_regeneration] run tellraw @s {"translate": "info.soul_alchemy.effect_permanent","color": "gray"}
