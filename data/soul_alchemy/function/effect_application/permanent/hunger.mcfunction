execute if entity @s[tag=permanent_hunger] run return run tellraw @s {"translate": "info.soul_alchemy.effect_already_permanent","color": "gray"}


execute if entity @s[tag=deactivate_hunger] run scoreboard players add @s npe_soul_points 8
execute if entity @s[tag=deactivate_hunger] run scoreboard players add @s npe_perma_effect_misc 1
execute if entity @s[tag=deactivate_hunger] run tellraw @s {"translate": "info.soul_alchemy.effect_permanent","color": "gray"}
