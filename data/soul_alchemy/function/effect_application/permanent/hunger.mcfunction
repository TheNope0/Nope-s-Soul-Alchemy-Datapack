execute if entity @s[tag=permanent_hunger] run return run tellraw @s {"translate": "n_soul_alchemy.inform.effect_already_permanent","color": "gray"}


execute if entity @s[tag=deactivate_hunger] run scoreboard players add @s npe_soul_points 8
execute if entity @s[tag=deactivate_hunger] run tellraw @s {"translate": "n_soul_alchemy.inform.effect_permanent","color": "gray"}
