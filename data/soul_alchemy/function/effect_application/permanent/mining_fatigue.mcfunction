execute if entity @s[tag=permanent_mining_fatigue] run return run tellraw @s {"translate": "info.soul_alchemy.effect_already_permanent","color": "gray"}
execute if entity @s[tag=permanent_haste] run return run tellraw @s {"translate": "info.soul_alchemy.mining_exclusive","color": "red"}


execute if entity @s[tag=deactivate_mining_fatigue] run scoreboard players add @s npe_soul_points 12
execute if entity @s[tag=deactivate_mining_fatigue] run scoreboard players add @s npe_perma_effect_misc 1
execute if entity @s[tag=deactivate_mining_fatigue] run tellraw @s {"translate": "info.soul_alchemy.effect_permanent","color": "gray"}
