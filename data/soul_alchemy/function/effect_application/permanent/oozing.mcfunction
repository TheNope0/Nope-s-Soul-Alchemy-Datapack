execute if entity @s[tag=permanent_oozing] run return run tellraw @s {"translate": "n_soul_alchemy.inform.effect_already_permanent","color": "gray"}


execute if entity @s[tag=deactivate_oozing] run scoreboard players add @s npe_soul_points 2
execute if entity @s[tag=deactivate_oozing] run tellraw @s {"translate": "n_soul_alchemy.inform.effect_permanent","color": "gray"}
