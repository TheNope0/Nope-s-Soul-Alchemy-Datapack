execute if entity @s[tag=permanent_night_vision] run return run tellraw @s {"translate": "n_soul_alchemy.inform.effect_already_permanent","color": "gray"}
...
execute if entity @s[tag=deactivate_night_vision] unless score @s npe_soul_points matches 8.. run return run tellraw @s {"translate": "n_soul_alchemy.inform.not_enough_sp","color": "red"}
execute if entity @s[tag=deactivate_night_vision] run scoreboard players remove @s npe_soul_points 8
execute if entity @s[tag=deactivate_night_vision] run tellraw @s {"translate": "n_soul_alchemy.inform.effect_permanent","color": "gray"}
