execute if score @s npe_current_move_speed matches ..-25 run return run tellraw @s {"translate": "n_soul_alchemy.inform.no_decrease","color": "red"}
...
execute if score @s npe_changed_stat matches 1 if score @s npe_current_move_speed matches -23 run attribute @s step_height base set 0.1
...
execute if score @s npe_changed_stat matches 1 if score @s npe_current_move_speed matches -22 run attribute @s step_height base set 0.2
...
execute if score @s npe_changed_stat matches 1 if score @s npe_current_move_speed matches -21 run attribute @s step_height base set 0.3
...
execute if score @s npe_changed_stat matches 1 if score @s npe_current_move_speed matches -20 run attribute @s step_height base set 0.4
...
execute if score @s npe_changed_stat matches 1 if score @s npe_current_move_speed matches -19 run attribute @s step_height base set 0.5
...
execute if score @s npe_changed_stat matches 1 if score @s npe_current_move_speed matches -9 run tellraw @s [{"text":"Warning! Any further speed decrease will negatively effect your jump height and step height!","color": "red"}]
...
execute if score @s npe_changed_stat matches 1 if score @s npe_current_move_speed matches 40 run attribute @s step_height base set 1.1
