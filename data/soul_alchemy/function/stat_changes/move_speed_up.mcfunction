...
execute if score @s npe_changed_stat matches 1 if score @s npe_current_move_speed matches -20 run attribute @s step_height base set 0.3
...
execute if score @s npe_changed_stat matches 1 if score @s npe_current_move_speed matches -18 run attribute @s step_height base set 0.4
...
execute if score @s npe_changed_stat matches 1 if score @s npe_current_move_speed matches -16 run attribute @s movement_speed base set 0.040
execute if score @s npe_changed_stat matches 1 if score @s npe_current_move_speed matches -16 run attribute @s step_height base set 0.5
...
execute if score @s npe_changed_stat matches 1 if score @s npe_current_move_speed matches -14 run attribute @s step_height base set 0.6
...
execute if score @s npe_changed_stat matches 1 if score @s npe_current_move_speed matches 14 run attribute @s step_height base set 1.1
execute if score @s npe_changed_stat matches 1 if score @s npe_current_move_speed matches 14 run scoreboard players set @s npe_changed_stat 0
execute if score @s npe_changed_stat matches 0 run return run scoreboard players set @s npe_current_move_speed 15
...
execute if score @s npe_changed_stat matches 1 if score @s npe_current_move_speed matches 29 run attribute @s step_height base set 1.6
...
execute if score @s npe_changed_stat matches 1 if score @s npe_current_move_speed matches 34 run attribute @s movement_speed base set 0.24
...
execute if score @s npe_changed_stat matches 1 if score @s npe_current_move_speed matches 39 run attribute @s movement_speed base set 0.26
