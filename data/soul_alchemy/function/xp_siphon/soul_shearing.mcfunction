...
execute if score @s npe_soul_points matches ..0 run return run tellraw @s {"translate": "info.soul_alchemy.not_enough_sp","color": "red"}
...
execute if score .SSDurabilityChange. npe_ultra_dummy matches 238 unless predicate soul_alchemy:soul_shears run playsound entity.item.break player @s ~ ~ ~
