...
item modify block ~ ~ ~ container.18 {function:"set_count",add:true,count:-64}

item modify block ~ ~ ~ container.13 {"function": "set_enchantments","enchantments": {"minecraft:mending": 2}}