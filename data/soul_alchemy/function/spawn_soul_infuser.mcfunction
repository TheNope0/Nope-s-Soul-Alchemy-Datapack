...
setblock ~ ~ ~ barrel{CustomName:'{"fallback":"Soul Infuser","translate":"n_soul_alchemy.block.soul_infuser"}',Items:[{id:stick,components:{custom_model_data:7843400,hide_tooltip:{},custom_data:{not_an_item:1b}},Slot:8}]} replace
