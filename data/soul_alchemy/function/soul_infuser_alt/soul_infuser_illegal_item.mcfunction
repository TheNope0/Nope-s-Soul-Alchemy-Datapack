execute at @s if items block ~ ~ ~ container.2 * positioned ~ ~ ~ run function soul_alchemy:soul_infuser_alt/macro_air_prevent_slots {slot: 2}
execute at @s if items block ~ ~ ~ container.3 * positioned ~ ~ ~ run function soul_alchemy:soul_infuser_alt/macro_air_prevent_slots {slot: 3}
execute at @s if items block ~ ~ ~ container.4 * positioned ~ ~ ~ run function soul_alchemy:soul_infuser_alt/macro_air_prevent_slots {slot: 4}
execute at @s if items block ~ ~ ~ container.5 * positioned ~ ~ ~ run function soul_alchemy:soul_infuser_alt/macro_air_prevent_slots {slot: 5}
...
execute at @s if items block ~ ~ ~ container.20 * positioned ~ ~ ~ run function soul_alchemy:soul_infuser_alt/macro_air_prevent_slots {slot: 20}
execute at @s if items block ~ ~ ~ container.21 * positioned ~ ~ ~ run function soul_alchemy:soul_infuser_alt/macro_air_prevent_slots {slot: 21}
execute at @s if items block ~ ~ ~ container.22 * positioned ~ ~ ~ run function soul_alchemy:soul_infuser_alt/macro_air_prevent_slots {slot: 22}
execute at @s if items block ~ ~ ~ container.23 * positioned ~ ~ ~ run function soul_alchemy:soul_infuser_alt/macro_air_prevent_slots {slot: 23}
execute at @s if items block ~ ~ ~ container.24 * positioned ~ ~ ~ run function soul_alchemy:soul_infuser_alt/macro_air_prevent_slots {slot: 24}
