execute if score @s npe_current_armor_toughness matches 5.. run return run tellraw @s {"text": "You already have the maximum amount for this stat!","color": "red"}
execute unless score @s npe_soul_points matches 4.. run return run tellraw @s {"text": "You do not have enough soul points to increase this stat!","color": "red"}

playsound minecraft:entity.experience_orb.pickup master @s ~ ~ ~
tellraw @s [{"text":"+1 ","color": "dark_green"},{"text":":armor_toughness:"}]
