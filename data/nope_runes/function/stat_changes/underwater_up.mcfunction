execute if score @s npe_current_luck matches 3.. run return run tellraw @s {"text": "You already have the maximum for these stats!","color": "red"}
...
tellraw @s [{"text":"+1 ","color": "dark_green"},{"text":":underwater:"}]
