...
execute if score @s npe_changed_stat matches 1 if score @s npe_current_absorption matches -1 run tellraw @s [{"text":"\uEE04","font": "nope_runes:chat_mojo"},{"text":"+3 ","color": "dark_green"}]
...
execute if score @s npe_changed_stat matches 1 if score @s npe_current_absorption matches 0 run tellraw @s [{"text":"\uEE04","font": "nope_runes:chat_mojo"},{"text":"+1 ","color": "dark_green"}]
...
execute if score @s npe_changed_stat matches 1 if score @s npe_current_absorption matches 1 run tellraw @s [{"text":"\uEE04","font": "nope_runes:chat_mojo"},{"text":"+1 ","color": "dark_green"}]
